...
export function TeamsTable() {
  ...
  const toggleAll = () => {
    setSelectedTeams((prev) =>
      prev.length === currentTeams.length && currentTeams.length > 0
        ? []
      ...
      {!isLoading && (
        <div
          ...
          <div className="overflow-x-auto">
            <div
              className="bg-primary text-primary-foreground min-w-[900px]"
              role="rowgroup">
              <div
            ...
            <div
              className="bg-card divide-y divide-border min-w-[900px]"
              role="rowgroup">
              {currentTeams.length === 0 ? (
                <div
                  ...
                  <div
                    ...
                    <div
                      ...
                      <DropdownMenu
                        ...
                        onOpenChange={(open) => {
                          console.log(
                            "[v0] Dropdown state changed for team:",
                            team.name,
                            "open:",
                            open
                          );
